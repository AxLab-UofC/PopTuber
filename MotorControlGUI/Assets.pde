...
void loadIcons() {
  ...
  playIcon.resize(LARGE_ICON_SIZE-10, LARGE_ICON_SIZE-10);
  ...
  expandIcon = loadImage("./icons/expand.png");
  feedIcon = loadImage("./icons/feed.png");
  feedIcon.resize(LARGE_ICON_SIZE-15, LARGE_ICON_SIZE-15);  
  fold1Icon = loadImage("./icons/fold1.png");
  fold1Icon.resize(LARGE_ICON_SIZE-20, LARGE_ICON_SIZE-20);  
  fold2Icon = loadImage("./icons/fold2.png");
  fold2Icon.resize(LARGE_ICON_SIZE-20, LARGE_ICON_SIZE-20);  
  fold3Icon = loadImage("./icons/fold3.png");
  fold3Icon.resize(LARGE_ICON_SIZE-20, LARGE_ICON_SIZE-20);  
  fold4Icon = loadImage("./icons/fold4.png");
  fold4Icon.resize(LARGE_ICON_SIZE-20, LARGE_ICON_SIZE-20);  
  fold5Icon = loadImage("./icons/fold5.png");
  fold5Icon.resize(LARGE_ICON_SIZE-20, LARGE_ICON_SIZE-20);  
  retractIcon = loadImage("./icons/retract.png");
  retractIcon.resize(LARGE_ICON_SIZE-10, LARGE_ICON_SIZE-10);  
  rotateIcon = loadImage("./icons/rotate.png");
  rotateIcon.resize(LARGE_ICON_SIZE-10, LARGE_ICON_SIZE-10);  
